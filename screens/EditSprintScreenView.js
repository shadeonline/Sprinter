...
import { firebaseEditSprint, firebaseFetchSprintTasks } from '../firebaseFunctions';
import TaskCard from '../components/TaskCard';

export default function EditSprintScreenView() {
  ...
  const fetchSprintTasks = async () => {
    try {
      const taskList = await firebaseFetchSprintTasks(sprint.tasks);
      setTasks(taskList);
